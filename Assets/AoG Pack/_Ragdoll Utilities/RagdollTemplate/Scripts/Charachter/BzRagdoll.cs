...
namespace BzKovSoft.RagdollTemplate.Scripts.Charachter
{
	...
	public sealed class BzRagdoll : MonoBehaviour, IBzRagdoll
	{
		...
		// animator animations:
		[SerializeField] private string _animationGetUpFromBelly = "GetUp.GetUpFromBelly";
		[SerializeField] private string _animationGetUpFromBack = "GetUp.GetUpFromBack";
		...
		private const float RagdollToMecanimBlendTime = 0.5f;   //How long do we blend when transitioning from ragdolled to animated
