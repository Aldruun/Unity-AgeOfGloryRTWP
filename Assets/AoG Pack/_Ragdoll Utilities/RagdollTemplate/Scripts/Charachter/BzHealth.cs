...
namespace BzKovSoft.RagdollTemplate.Scripts.Charachter
{
	...
	{
		[SerializeField] private IBzRagdoll _bzRagdoll;
		...
		private float _impactEndTime;		//Declare a member variables for distributing the impacts over several frames
		private Rigidbody _impactTarget;	//Limb to witch an impact was targeted
