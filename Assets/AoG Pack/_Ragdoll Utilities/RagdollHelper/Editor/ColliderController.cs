...
namespace BzKovSoft.RagdollHelper.Editor
{
	internal class ColliderController
	{
		...
		/// </summary>
		private static void ProcessRotation(BoneHelper boneHelper, Quaternion rotatorRotation, Quaternion lastRotation, Transform transform, Vector3 pos)
		{
		...
		private static void ProcessColliderMove(Quaternion rotatorRotation, Transform transform, Vector3 pos)
		{
			if (Tools.pivotRotation == PivotRotation.Global)
		...
		/// </summary>
		private static void ProcessColliderScale(BoneHelper boneHelper, Quaternion rotatorRotation, Transform transform, Vector3 pos)
		{
		...
		/// </summary>
		private static Vector3 DirectionIntToVector(int direction)
		{
			Vector3 v;
			switch (direction)
			{
