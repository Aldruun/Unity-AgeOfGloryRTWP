...
public class SpriteAnimationController : MonoBehaviour
{
    ...
    //Update
    public void UpdateFrames() { /*if(update)*/ SetSpriteAnimation(colCount, rowCount, rowNumber, colNumber, totalCells, fps); }
    ...
    private void SetSpriteAnimation(int colCount, int rowCount, int rowNumber, int colNumber, int totalCells, int fps)
    {
        ...
        // Calculate index
        index = (int)(Time.unscaledTime * fps);
        ...
        GetComponent<Renderer>().material.SetTextureScale("_BaseMap", size);
    }
