...
public class GrassPlacement : EditorWindow
{
    ...
    public int detailCountPerDetailPixel = 16;
    public float spawnAngle = 0.7f;
    ...
    private void OnGUI()
    {
        ...
        if(terrain != null)
        {
            detailCountPerDetailPixel = EditorGUILayout.IntSlider(new GUIContent("Detail Counter Per Detail Pixel:", "The detail count per detail pixel"), detailCountPerDetailPixel, 0, 16);
            ...
            spawnAngle = 1 - EditorGUILayout.Slider(new GUIContent("Spawn Angle:", "The angle at which detail objects can be placed"), spawnAngle, 0f, 1f);
