...
public static class SpellCasting
{
    ...
    /// <returns></returns>
    public static bool InflictMagicEffectsAtActor(Spell spell, ActorInput caster, ActorInput target)
    {
    ...
    public static void CastSpraySpellInDirection(Spell spell, ActorInput caster, Vector3 targetPoint, float duration)
    {
        if(caster == null || caster.dead)
        {
            return;
    ...
    public static void LaunchMagicProjectile(Spell spell, ActorInput caster, Vector3 targetLocation)
    {
        if(caster == null || caster.dead)
        {
            return;
    ...
    private static void ApplyVFXToActor(ActorInput caster, ActorInput target, EffectData effectData, float delay)
    {
    ...
    public static bool SpellCostCovered(Spell spell, ActorInput caster)
    {
    ...
    public static bool CanCastSpell(Spell spell, ActorInput caster)
    {
    ...
    public static Spell ChooseBestSpell(ActorInput caster, ActorInput target)
    {
        if(caster == null || caster.dead)
        {
            return null;
    ...
    public static Spell ChooseBestSpellFromSchool(ActorInput caster, ActorInput target, MagicSchool[] targetSchools)
    {
        if(caster == null || caster.dead)
        {
            return null;
    ...
    public static Spell ChooseAnySpellWithKeyword(ActorInput caster, Keyword keywords)
    {
        if(caster == null || caster.dead)
        {
            return null;
    ...
    private static float GetTotalEffectsRating(Spell spell, ActorInput caster, ActorInput target, bool hostile)
    {
    ...
    public static bool CanCast(ActorInput input)
    {
        if(input.dead)
        {
